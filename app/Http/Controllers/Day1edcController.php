...
$dataByRoom = $dataa->groupBy('room');
 ...
 public function gabungan(){
    ...
    $dataa4 = $now->gte($waktuTargetDay2Ronde2) ? day2edc::where('ronde', '2')->orderBy('sesi')->get() : collect();

    return view('matalomba/edc/penyisihan', compact('groupedByTeam', 'dataa', 'dataa2', 'dataa3', 'dataa4'));
 }
    }
