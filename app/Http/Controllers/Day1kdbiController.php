...
$dataByRoom = $dataa->groupBy('room');
 ...
 public function gabungankdbi(){
    ...
    $waktuTargetDay1Ronde2 = Carbon::createFromFormat('Y-m-d H:i:s', '2024-05-19 15:00:00', 'Asia/Jakarta'); 

    // Waktu target untuk ronde 1 day2edc
    $waktuTargetDay2Ronde1 = Carbon::createFromFormat('Y-m-d H:i:s', '2024-05-19 15:00:00', 'Asia/Jakarta'); 

    // Waktu target untuk ronde 2 day2edc
    $waktuTargetDay2Ronde2 = Carbon::createFromFormat('Y-m-d H:i:s', '2024-05-19 15:00:00', 'Asia/Jakarta'); 
    ...
    $totalVpDay2Ronde2 = collect();
    if ($now->gte($waktuTargetDay2Ronde2)) {
    ...
    $dataa4 = $now->gte($waktuTargetDay2Ronde2) ? day2kdbi::where('ronde', '2')->orderBy('sesi')->get() : collect();

    return view('matalomba/kdbi/penyisihan', compact('groupedByTeam', 'dataa', 'dataa2', 'dataa3', 'dataa4'));
 }
