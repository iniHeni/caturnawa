...
<div id="data-box">
    ...
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaKDBId3') }}"  class="card-item">
            ...
            <a  href="{{url('admin/pesertaKDBI2d3') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI3d3') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
...
<div id="data-box">
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaKDBI4d3') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI5d3') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI6d3') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
