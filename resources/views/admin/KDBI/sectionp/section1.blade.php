...
<div id="data-box">
    ...
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaKDBI') }}"  class="card-item">
            ...
            <a  href="{{url('admin/pesertaKDBI2') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI3') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
...
<div id="data-box">
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaKDBI4') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI5') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI6') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
