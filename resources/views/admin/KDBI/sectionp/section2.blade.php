...
<div id="data-box">
    ...
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaKDBId2') }}"  class="card-item">
            ...
            <a  href="{{url('admin/pesertaKDBI2d2') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI3d2') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
...
<div id="data-box">
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaKDBI4d2') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI5d2') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaKDBI6d2') }}" class="card-item">
                <img src="../../img/kdbi2.png" alt="Card Image">
