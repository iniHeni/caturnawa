...
<div id="data-container">
    <section id="skor">
        <div class="container" style="display: flex; justify-content: center;height:70rem">
            <div style="width: 100%;">
                <h1 class="welcome" style="margin-bottom: 1rem; margin-top:auto">Data Sesi 4</h1>
                    ...
                    <table class="table table-bordered table-striped" style="min-width: 650px; margin-bottom: 0; border-collapse: collapse;">
                        <thead style="position: static; top: -1; z-index: 10;">
                            <tr>
                                ...
                                <th scope="col" rowspan="2">Sesi</th>
                                <th scope="col" rowspan="2">Nama Juri</th>
                                <th scope="col" rowspan="2">Room </th>
                                <th scope="col" rowspan="2">tim</th>
                                <th scope="col" colspan="4">Posisi</th>
                                <th scope="col" rowspan="2">Posisi</th>
                                <th scope="col" rowspan="2">Nama Peserta</th>
                                <th scope="col" colspan="2">Skor</th>
