...
<section style="height: 60rem" >
    <div class="konten">
      ...
      <form action="{{ route('kdbi.updatekdbi2', $edit->id) }}" method="POST" enctype="multipart/form-data"  id="penilaian" >
          @csrf
            ...
            <div class="details personal">
                ...
                <div class="fields"> 
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" id="room" name="room" placeholder="Masukkan Ruangan" value="{{ $edit->room }}" required>
                    </div>
                    <div class="input-field">
