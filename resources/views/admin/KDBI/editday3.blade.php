...
<section style="height: 60rem" >
    <div class="konten">
      ...
      <form action="{{ route('kdbi.updatekdbi3', $edit->id) }}" method="POST" enctype="multipart/form-data"  id="penilaian" >
          @csrf
...
<script>
    ...
    namaPesertaSelect.addEventListener('change', () => {
        ...
        if (selectedPeserta) {
            ...
            universitySelect.value = selectedPeserta.nama1;
