                    ...
                    <table class="table table-bordered " style="min-width: 650px; margin-bottom: 0; border-collapse: collapse;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: left">1. Penyajian Karya Tulis</td>
                                <td class="mid">{{ $peserta->scorepenyajian}}</td>
                                <td>{{ $peserta->penyajian}}</td>
                            ...
                            <tr>
                                <td style="text-align: left">2. Substansi Karya Tulis</td>
                                <td class="mid">{{ $peserta->scoresubs}}</td>
                                <td>{{ $peserta->subs}}</td>
                            </tr>
                            <tr>
                                <td style="text-align: left">3. Kualitas Karya Tulis ilmiah</td>
                                <td class="mid">{{ $peserta->scorekualitas}}</td>
                                <td>{{ $peserta->kualitas}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                        @endforeach
