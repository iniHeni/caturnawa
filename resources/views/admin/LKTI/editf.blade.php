      ...
      <form action="{{ route('spc.updatef', $edit->id) }}" method="POST" enctype="multipart/form-data" id="penilaian" >
          ...
          <span class="title">1. Pemaparan Materi dan Presentasi ilmiah</span>
            ...
            <div class="input-field">
                ...
                <textarea type="text" id="materi" name="materi" value="{{ $edit->materi }}"></textarea>
            </div>
              </div>
          </div>
          <div class="details personal">
              <span class="title">2. Pertanyaan dan Jawaban</span>
                ...
                <div class="input-field">
                    ...
                    <textarea type="text" id="pertanyaandanjawaban" name="pertanyaandanjawaban" value="{{ $edit->pertanyaandanjawaban }}"></textarea>
                </div>
                  </div>
              </div>
              <div class="details personal">
                  <span class="title">3. Aspek Kesesuaian dengan Tema</span>
                    ...
                    <div class="input-field">
                        ...
                        <textarea type="text" id="kesesuaian" name="kesesuaian" value="{{ $edit->kesesuaian }}"></textarea>
                    </div>
                      </div>
                  </div>
