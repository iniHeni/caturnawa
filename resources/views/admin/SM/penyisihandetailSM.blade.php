        ...
        <div class="container" style="display: flex; justify-content: center;height:70rem">
            <div style="width: 100%;">
                <div class="table-responsive" style="max-height: 1000px;  position: static;">
                  <table class="table table-bordered" style="min-width: 650px; margin-bottom: 0; border-collapse: collapse;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align: left">Ketepatan dan kesesuaian white balance</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Ketepatan dan kesesuaian angle, pergerakan kamera, dan komposisi</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Ketepatan dan kesesuaian key light</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Ketepatan dan kesesuaian teknik penataan lampu</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Kesesuaian film dengan tema</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Kesesuaian antara fakta dan realita dengan cerita yang diangkat dalam film</td>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left">Kreatifitas dalam menceritakan realita dari sudut pandang yang berbeda</td>
                  ...
                  <tr>
                    ...
                    <td style="text-align: left">Seberapa orisinalitas cerita dalam script</td>
                ...
                <tr>
                  ...
                  <td style="text-align: left">Kedalaman riset dan observasi dalam film</td>
              ...
              <tr>
                ...
                <td style="text-align: left">Kesesuaian antara gambar dan suara serta estetika dalam film</td>
                <td>{{ $data->skorkrit10}}</td>
                
            </tr>
            <tr>

              <td style="text-align: left">Ketepatan dan kesesuaian teknik cutting</td>
              <td>{{ $data->skorkrit11}}</td>
             
          </tr>
          <tr>
            <td style="text-align: left">Jumlah Like Video</td>
