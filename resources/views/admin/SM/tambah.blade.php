    ...
    <div class="konten">
      ...
      <form action="/tambahsm/penyisihan" method="POST" enctype="multipart/form-data" id="penilaian" >
        ...
        <div class="input-field">
         ...
         @error('skorkrit2')
          ...
          <div class="input-field">
            ...
            <input type="number" id="skorkrit3" name="skorkrit3" oninput="hitungTotal()" placeholder=" Masukkan Kuantitatif" @error('skorkrit3') is-invalid @enderror required>
        @error('skorkrit3')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                </div>
        <div class="input-field">
          ...
          <textarea id="krit3" name="krit3"  required ></textarea>
      </div>
        <div class="input-field">
          <label for="skorkrit4">4.Editing</label>
          <input type="number" id="skorkrit4" name="skorkrit4" oninput="hitungTotal()" placeholder=" Masukkan Kuantitatif" @error('skorkrit4') is-invalid @enderror required>
       @error('skorkrit4')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                </div>
      <div class="input-field">
        ...
        <textarea id="krit4" name="krit4"  required ></textarea>
    </div>
        <div class="input-field">
          <label for="skorkrit5">5. Suara</label>
          <input type="number" id="skorkrit5" name="skorkrit5" oninput="hitungTotal()" placeholder=" Masukkan Kuantitatif" @error('skorkrit5') is-invalid @enderror required>
       @error('skorkrit5')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                </div>
      <div class="input-field">
        ...
        <textarea id="krit5" name="krit5"  required ></textarea>
    </div>
              </div>
          </div>
