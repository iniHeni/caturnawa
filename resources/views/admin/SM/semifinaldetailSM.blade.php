...
<div id="data-container">
    <section id="skor">
        <div class="container" style="display: flex; justify-content: center;height:70rem">
            <div style="width: 100%;">
                <div class="table-responsive" style="max-height: 1000px;  position: static;">
                  <table class="table table-bordered" style="min-width: 650px; margin-bottom: 0; border-collapse: collapse;">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td style="text-align: left">Ekspresi wajah dan gestur</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Seberapa baik aktor memahami dan mengembangkan karakter yang diperankan</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Kemampuan menyampaikan dialog dengan intonasi, ritme, dan emosi yang tepat</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left"> Kemampuan mempengaruhi dan menggerakan emosi penonton</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">Kesesuaian dengan karakter</td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left"> Estetika dan desain</td>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left">Bagaimana kostum berkontribusi pada estetika visual keseluruhan film dan kesan yang ingin disampaikan kepada penonton</td>
                  ...
                  <tr>
                    ...
                    <td style="text-align: left">Kreatifitas dalam memadukan unsur video dan audio dalam menyusun alur cerita berdasarkan informasi dan realitas yang diperoleh menjadi suatu yang menarik untuk ditonton</td>
                ...
                <tr>
                  ...
                  <td style="text-align: left">Kelarasan musik dengan film</td>
              ...
              <tr>
                ...
                <td style="text-align: left">Ketepatan poster dengan film</td>
                <td>{{ $data->skorkrit10}}</td>
                
            </tr>
            <tr>

              <td style="text-align: left">Komposisi gambar : Warna dan Tata letak objek dalam gambar</td>
              <td>{{ $data->skorkrit11}}</td>
             
          </tr>
          <tr>

            <td style="text-align: left">Keindahan/sisi artistik penyajian visual</td>
        ...
        <tr><td colspan="1">Total Score</td>
          ...
          <tr><td scope="col" colspan="2" style="text-align: left;">Notes:{{ $data->note }}</td>
          </tr>
