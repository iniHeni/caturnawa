...
<section style="height: 60rem" >
    <div class="konten">
      ...
      <form action="{{ route('sm.updatepee', $edit->id) }}" method="POST"  id="penilaian" enctype="multipart/form-data">
          @csrf
            ...
            <div class="details ID">
                ...
                <div class="fields"> 
                    ...
                    <div class="input-field">
                        ...
                        <input name="nama1" id="nama1" type="text" placeholder="Nama Peserta" required value="{{ $edit->nama1 }}">
                    </div>
                    <div class="input-field">
                        <label for="nama2">Nama Peserta 3</label>
                        <input name="nama2" id="nama2" type="text" placeholder="Nama Peserta" required value="{{ $edit->nama2 }}">
                    </div>
                    <div class="input-field">
                        <label for="nama3">Nama Peserta 4</label>
                        <input name="nama3" id="nama3" type="text" placeholder="Nama Peserta" required value="{{ $edit->nama3 }}">
                    </div>
                    <div class="input-field">
                        <label for="nama4">Nama Peserta 5</label>
                        <input name="nama4" id="nama4" type="text" placeholder="Nama Peserta" required value="{{ $edit->nama4 }}">
                    </div>
                    <div class="input-field">
                    ...
                    <div class="input-field">
                        ...
                        <input name="email1" id="email1" type="email" placeholder="Email Peserta" required value="{{ $edit->email1 }}">
                    </div>
                    <div class="input-field">
                        <label for="email2">Email Peserta 3</label>
                        <input name="email2" id="email2" type="email" placeholder="Email Peserta" required value="{{ $edit->email2 }}">
                    </div>
                    <div class="input-field">
                        <label for="email3">Email Peserta 4 </label>
                        <input name="email3" id="email3" type="email" placeholder="Email Peserta" required value="{{ $edit->email3 }}">
                    </div>
                    <div class="input-field">
                        <label for="email4">Email Peserta 5 </label>
                        <input name="email4" id="email4" type="email" placeholder="Email Peserta" required value="{{ $edit->email4 }}">
                    </div>
                        <div class="input-field">
                        ...
                        <div class="input-field">
                            ...
                            <input name="nohp1" id="nohp1" type="number" placeholder="Nomer hp Peserta" required value="{{ $edit->nohp1 }}">
                        </div>
                        <div class="input-field">
                            <label for="nohp2">No Peserta Handphone 3</label>
                            <input name="nohp2" id="nohp2" type="number" placeholder="Nomer hp Peserta" required value="{{ $edit->nohp2 }}">
                        </div>
                        <div class="input-field">
                            <label for="nohp3">No Peserta Handphone 4</label>
                            <input name="nohp3" id="nohp3" type="number" placeholder="Nomer hp Peserta" required value="{{ $edit->nohp3 }}">
                        </div>
                        <div class="input-field">
