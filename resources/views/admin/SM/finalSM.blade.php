                ...
                <div class="table-responsive" style="max-height: 1900px; overflow-x: auto; overflow-y: auto; position: static;">
                    <table class="table table-bordered table-striped" style="min-width: 1700px; margin-bottom: 0; border-collapse: collapse;">
                        <thead style="position: static; top: -1; z-index: 10;">
                            ...
                            <tr >
                                <th scope="col" colspan="1">Ide cerita dan riset peristiwa dalam film</th>
                                <th scope="col"colspan="1">Tujuan film dan pengaruh film</th>
                                <th scope="col"colspan="1">Kemampuan dan pemahaman membuat film</th>
                                <th scope="col"colspan="1">Informasi dan pesan yang disampaikan dari film</th>
                            </tr>
