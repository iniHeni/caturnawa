    ...
    <section id="skor">
        <div class="container" style="display: flex; justify-content: center;height:70rem">
            <div style="width: 100%;">
                ...
                <p><a class="add" href="{{ route('edc.pesertaday1') }}" style="color: white">Tambah Penilaian</a></p>
    ...
    @foreach ($sesiChunks as $sesi => $dataSesi)
                    <table class="table table-bordered " style="min-width: 650px; margin-bottom: 5rem; border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <td>{{ $data->vp}}</td>
                            <td>
                                <a href="{{ route('edc.editedc', $data->id) }}">Edit</a>
                                <form action="{{ route('edc.hapusedc', $data->id) }}" method="POST" id="delete-form-{{ $data->id }}">
                                    @csrf 
