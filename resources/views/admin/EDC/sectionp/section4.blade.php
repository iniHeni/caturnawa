...
<div id="data-box">
    ...
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDCd4') }}"  class="card-item">
            ...
            <a  href="{{url('admin/pesertaEDC2d4') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC3d4') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
...
<div id="data-box">
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDC4d4') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC5d4') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC6d4') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
