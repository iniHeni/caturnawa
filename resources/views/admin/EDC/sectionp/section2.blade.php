...
<div id="data-box">
    ...
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDCd2') }}"  class="card-item">
            ...
            <a  href="{{url('admin/pesertaEDC2d2') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC3d2') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
...
<div id="data-box">
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDC4d2') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC5d2') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC6d2') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
