...
<a href="#" id="menu"><img  class="sidelogo" id="sidelogo"  src="../../../img/uf2.png" alt="Logo"></a>
    ...
    <a href="{{url('admin/mainmenuEDC') }}" class="penyisihan"><i class="fa fa-users"></i> Penyisihan</a>
    <a href="{{url('admin/mainmenuEDC') }}" class="semifinal"><i class="fa fa-list-alt"></i> SemiFinal</a>
    <a href="{{url('admin/mainmenuEDC') }}"  class="final"><i class="fa fa-trophy"></i> Final</a>
...
<div >
<div id="data-box">
        <h1 class="welcome" style="margin-bottom: -3rem; margin-top:auto">Sesi Ronde 1<br>
        Day 2</h1>
        
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDCd3') }}"  class="card-item">
            ...
            <a  href="{{url('admin/pesertaEDC2d3') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC3d3') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
...
<div id="data-box">
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDC4d3') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC5d3') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC6d3') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
