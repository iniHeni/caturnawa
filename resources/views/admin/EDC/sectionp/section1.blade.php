...
<div id="data-box">
    ...
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDC') }}"  class="card-item">
            ...
            <a  href="{{url('admin/pesertaEDC2') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC3') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
...
<div id="data-box">
    <div style="max-width: 78rem;" class="card-list">
        <a href="{{url('admin/pesertaEDC4') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC5') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
            ...
            <a href="{{url('admin/pesertaEDC6') }}" class="card-item">
                <img src="../../../img/edc.png" alt="Card Image">
