...
<section style="height: 60rem" >
    <div class="konten">
      ...
      <form action="{{ route('edc.updateedc3', $edit->id) }}" method="POST" enctype="multipart/form-data"  id="penilaian" >
          @csrf
          <div class="form first">
            <div class="details personal">
                <span class="title">Data Juri</span>
                <div class="fields"> 
            ...
            <div class="details personal">
                <span class="title">Data Penilaian Team</span>
                <div class="fields"> 
                    <div class="input-field">
...
<script>
    ...
    namaPesertaSelect.addEventListener('change', () => {
        ...
        if (selectedPeserta) {
            universitySelect.options.add(new Option(selectedPeserta.nama1, selectedPeserta.nama1));
            universitySelect.value = selectedPeserta.nama;
            universitySelect2.options.add(new Option(selectedPeserta.nama2, selectedPeserta.nama2));
