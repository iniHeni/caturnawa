   ...
   <body>
      ...
      <header class="header" id="header">
        ...
        <div style="margin-right: 19rem" class="nav__item">
						...
						<li><a href="{{url('matalomba/daftarKDBI_eng') }}" height="20"><img src="../../img/eng.png" /></a></li>
					</div>
                  <li class="nav__item">
                  ...
                  <li class="nav__item">
                     <a href="{{url('matalomba/kdbi') }}" class="nav__link">Peserta</a>
                  </li>

                  <li class="nav__item">
                     <a href="{{url('matalomba/scoreKDBI') }}" class="nav__link">Skor</a>
                  </li>

                  <li class="nav__item">
                     <a href="{{url('matalomba/kdbi') }}" class="nav__link">Babak</a>
                  </li>
                  
                  <li class="nav__item">
                     <a href="{{url('matalomba/kdbi') }}" class="nav__link">Juri</a>
                  </li>
               </ul>
