...
<section id="rank">
    ...
    <div class="card-list">
            <a href="{{url('matalomba/kdbi/penyisihan/round1') }}" class="card-item">
            ...
            <a href="{{url('matalomba/kdbi/penyisihan/round2') }}" class="card-item" id="round2">
                <img src="../../../img/kdbi2.png" alt="Card Image">
                <h3>Round 2</h3>
                <div class="arrow">
                    <i class="card-icon">Detail</i>
        ...
        <div class="card-list">
                <a href="{{url('matalomba/kdbi/penyisihan/round3') }}" class="card-item" id="round3">
                    <img src="../../../img/kdbi2.png" alt="Card Image">
                    <h3>Round 1</h3>
                    <div class="arrow">
                        <i class="card-icon">Detail</i>
                ...
                <a href="{{url('matalomba/kdbi/penyisihan/round4') }}" class="card-item">
                    <img src="../../../img/kdbi2.png" alt="Card Image">
                    <h3>Round 2</h3>
                    <div class="arrow">
                        <i class="card-icon">Detail</i>
