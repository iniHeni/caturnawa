...
<section id="rank">
    ...
    <div class="card-list">
            <a href="{{url('/matalomba/penyisihanKDBI/round1') }}" class="card-item">
            ...
            <a href="{{url('/matalomba/penyisihanKDBI/round2') }}" class="card-item" id="round2">
                <img src="../../img/kdbi2.png" alt="Card Image">
                <h3>Round 2</h3>
                <div class="arrow">
                    <i class="card-icon" id="round2">Detail</i>
                </div>
            </a>
        </div>
        <h1 class="judul">Day 2</h1>
        <div class="card-list">
                <a href="{{url('/matalomba/penyisihanKDBI/round3') }}" class="card-item"id="round3">
                    <img src="../../img/kdbi2.png" alt="Card Image">
                    <h3>Round 1</h3>
                    <div class="arrow">
                        <i class="card-icon" id="round3">Detail</i>
                    </div>
                </a>
                <a href="{{url('/matalomba/penyisihanKDBI/round4') }}" class="card-item">
                    <img src="../../img/kdbi2.png" alt="Card Image">
                    <h3>Round 2</h3>
                    <div class="arrow">
                        <i class="card-icon">Detail</i>
