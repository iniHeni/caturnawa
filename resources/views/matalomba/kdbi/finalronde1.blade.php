...
@keyframes blink { 
  ...
  100% { opacity: 1; } 
      ...
      <title>Caturnawa - KDBIFinalRound1</title>
   </head>
   <body>
    <div id="loadingDiv">
     ...
     <h3 class="testing1" style="color: white; text-align:center; margin-top: 20px">Dewan ini percaya bahwa momentum hijau global tidak dapat dicapai tanpa Komitmen Politik Bipartisan untuk Inovasi Energi Terbarukan.</h3>
      <section id="skor">
