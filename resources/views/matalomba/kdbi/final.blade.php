            ...
            <h3>Round 1</h3>
              <a href="#" onclick="
                  ...
                  @else 
                      ...
                      window.location.href = '{{ url('matalomba/kdbi/finalday1/round1' ) }}'; 
                  @endif
              ">
                            <div class="arrow">
              ...
              <h3>Round 2</h3>
                <a href="#" onclick="
                    ...
                    @else 
                        ...
                        window.location.href = '{{ url('matalomba/kdbi/finalday1/round2') }}'; 
                    @endif
                ">
                              <div class="arrow">
                                  <i class="card-icon1">Detail</i>
          ...
          <h3>Round 3</h3>
            <a href="#" onclick="
                ...
                @else 
                    ...
                    window.location.href = '{{ url('matalomba/kdbi/finalday2/round1') }}'; 
                @endif
            ">
                          <div class="arrow">
                              <i class="card-icon1">Detail</i>
