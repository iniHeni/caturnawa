...
@keyframes blink { 
  ...
  100% { opacity: 1; } 
      ...
      <title>Caturnawa - EDCFinalDay2</title>
   </head>
   <body>
    <div id="loadingDiv">
     ...
     <h3 class="testing1" style="color: white; text-align:center; margin-top: 20px">This house will ban high carbon polluting countries from participating in international events (not limited to international Olympics, summits, student exchanges, etc.)</h3>
      <section id="skor">
