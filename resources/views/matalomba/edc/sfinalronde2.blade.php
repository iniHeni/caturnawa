...
@keyframes blink { 
  ...
  100% { opacity: 1; } 
      ...
      <title>Caturnawa - EDCSFRound2</title>
   </head>
   <body>
    <div id="loadingDiv">
      ...
      <!--==================== Session ====================-->
      <h3 style="color: white; text-align:center">@lang('messages.moosi')</h3>
          <h3 class="testing1" style="color: white; text-align:center; margin-top: 20px">" @lang('messages.mosir52')"</h3>
      <section id="skor">
        <div class="container" style="display: flex; justify-content: center;height:70rem">
            <div style="width: 100%;">
                  @foreach ($dataByRoom as $room => $dataa)
                  <h3 style="color: white; text-align:center; padding: 50px 20">Breakout Room {{ $room }}</h3>
