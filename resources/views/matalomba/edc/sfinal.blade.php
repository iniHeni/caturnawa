<html lang="en">
   <head>
      ...
      <title>Caturnawa - EDCSemiFinal</title>
      <style>
      ...
      <section id="skor">
        <div class="container" style="display: flex; justify-content: center;">
            <div style="width: 100%;">
                ...
                <div class="table-responsive" style=" overflow-x: auto; overflow-y: auto; position: relative; margin-bottom: 80px; border-radius: 20px">
...
<section id="rank">
  ...
  <a href="#" class="card-item" onclick="
      ...
      @else 
          ...
          window.location.href = '{{url('matalomba/edc/semifinal/round1') }}'; 
      @endif
  ">
