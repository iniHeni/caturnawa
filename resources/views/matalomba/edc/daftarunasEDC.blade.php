...
<section>
    <div class="konten">
      ...
      <form action="/unascheckout" method="POST" enctype="multipart/form-data" >
          @csrf
              ...
              <div class="details ID">
                  ...
                  <div class="fields">
                      <div class="input-field">
                          ...
                          <input type="text" name="namateam" id="namateam" placeholder="@lang('messages.place') @lang('messages.team2')"  @error('namateam') is-invalid @enderror required>
                          @error('namateam')
                          <div class="text-danger">{{ $message }}</div>
                          @enderror
                      </div>
