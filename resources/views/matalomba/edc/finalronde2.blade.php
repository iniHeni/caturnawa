  ...
  100% { opacity: 1; } 
   ...
   <body>
    <div id="loadingDiv">
     ...
     <h3 class="testing1" style="color: white; text-align:center; margin-top: 20px">This house would abandon the narrative that the consequences of climate change are apocalyptic in nature.</h3>
      <section id="skor">
