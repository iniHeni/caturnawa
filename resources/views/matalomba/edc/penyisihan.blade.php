...
<section id="rank">
    ...
    <div class="card-list">
      ...
      $ronde2 = Carbon::parse('2024-05-15');
      $ronde3 = Carbon::parse('2024-05-28');
...
@foreach($dataa->groupBy('sesi') as $sesi => $dataPerSesi)
  <a href="#" onclick="
      ...
      @else 
          ...
          window.location.href = '{{ route('edc.detailday1r1', $sesi) }}'; 
      @endif
  ">
                <div class="arrow">
  ...
  @foreach($dataa2->groupBy('sesi') as $sesi2 => $dataPerSesi2)
    <a href="#" onclick="
        ...
        @else 
            ...
            window.location.href = '{{ route('edc.detailday1r2', $sesi2) }}'; 
        @endif
    ">
                  <div class="arrow">
            ...
            @foreach($dataa3->groupBy('sesi') as $sesi3 => $dataPerSesi3)
              <a href="#" onclick="
                  ...
                  @else 
                      ...
                      window.location.href = '{{ route('edc.detailday2r1', $sesi3) }}'; 
                  @endif
              ">
                            <div class="arrow">
              ...
              @foreach($dataa4->groupBy('sesi') as $sesi4 => $dataPerSesi4)
                  ...
                  @else 
                      ...
                      window.location.href = '{{ route('edc.detailday2r2', $sesi4) }}'; 
                  @endif
              ">
                            <div class="arrow">
