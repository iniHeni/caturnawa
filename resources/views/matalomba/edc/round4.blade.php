...
background: center / contain no-repeat url(../../img/loader.gif);
      ...
      <title>Caturnawa - EDCRound4</title>
   </head>
   <body>
    <div id="loadingDiv">
...
<section id="rank">
    ...
    <div class="card-list">
            <a href="{{url('matalomba/penyisihanEDC/round4/session7') }}" class="card-item">
            ...
            <a href="{{url('matalomba/penyisihanEDC/round4/session8') }}" class="card-item">
                <img src="../../img/edc.png" alt="Card Image">
                <h3>Session 2</h3>
                <div class="arrow">
                    <i class="card-icon">Detail</i>
            ...
            <a href="{{url('matalomba/penyisihanEDC/round4/session9') }}" class="card-item">
                <img src="../../img/edc.png" alt="Card Image">
                <h3>Session 3</h3>
                <div class="arrow">
                    <i class="card-icon">Detail</i>
            ...
            <a href="{{url('matalomba/penyisihanEDC/round4/session10') }}" class="card-item">
                <img src="../../img/edc.png" alt="Card Image">
                <h3>Session 4</h3>
                <div class="arrow">
                    <i class="card-icon">Detail</i>
            ...
            <a href="{{url('matalomba/penyisihanEDC/round4/session11') }}" class="card-item">
                <img src="../../img/edc.png" alt="Card Image">
                <h3>Session 5</h3>
                <div class="arrow">
                    <i class="card-icon">Detail</i>
            ...
            <a href="{{url('matalomba/penyisihanEDC/round4/session12') }}" class="card-item">
                <img src="../../img/edc.png" alt="Card Image">
                <h3>Session 6</h3>
                <div class="arrow">
                    <i class="card-icon">Detail</i>
