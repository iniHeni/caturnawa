<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="../../css/cardpeserta.css">
   ...
   <body>
      ...
      <header class="header" id="header">
         ...
         <img src="../../img/edcfull.png" width="180" class="nav_gmbar">
            <h2><a href="edc.php" class="nav__logo" style="margin-left: -5rem">EDC</a></h2>

            <div class="nav__menu" id="nav-menu">
               <ul class="nav__list">
               <div style="margin-right: 10rem" class="gmbar">
						<li><a href="edc.php" height="20"><img src="../../img/ind.png"  /></a></li>
						<li><a href="edc_eng.php" height="20"><img src="../../img/eng.png" /></a></li>
					</div>
                  <li class="nav__item">
                  ...
                  <li class="nav__item">
                     <a href="score.php" class="nav__link">Skor</a>
                  </li>
                ...
                <div class="card-wrapper swiper-wrapper">
                    <div class="card swiper-slide">
                        ...
                        <div class="card-content">
                            ...
                            <button class="button"><a href="detailpeserta.php">Masuk Untuk Detail</a></button>
                        </div>
                    </div>
                    <div class="card swiper-slide">
                        <div class="image-content">
