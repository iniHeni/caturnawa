                ...
                <div class="details personal">
                    ...
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                ...
                                <input disabled value="{{$orderlkti->sertifikat}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat1}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat2}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat3}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat4}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat5}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat6}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat7}}">
                            </div>
                        </div>
                    </div>
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat8}}">
                            </div>
                        </div>
                    </div>          
                    <div class="details ID">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label>@lang('messages.sertif')</label>
                                <input disabled value="{{$orderlkti->sertifikat9}}">
                            </div>  
                        </div>
