   ...
   <body>
      ...
      <section id="rank">
         ...
         <div class="card-list">
            ...
            use Carbon\Carbon;
            $today = Carbon::now();
            $penyisihanStart = Carbon::parse('2024-06-22');
            $penyisihanEnd = Carbon::parse('2024-09-28');
            $semiFinalDate = Carbon::parse('2024-4-30');
            $finalDate = Carbon::parse('2024-4-15');
            @endphp
          ...
          ">
               ...
               <h3>@lang('messages.dilaksanakan')<br>27 - 28 September 2024</h3>
               <div class="arrow">
            ...
            <a href="#" class="card-item" onclick="
              ...
              @else
                  window.location.href = '{{ url('matalomba/sm/sfinal') }}';
              @endif
          ">
               <img src="../../img/sm1.png" alt="Card Image">
               <span class="designer">Semifinal</span>
               <h3>@lang('messages.dilaksanakan')<br>30 September 2024</h3>
               <div class="arrow">
          ...
          ">
               ...
               <h3>@lang('messages.dilaksanakan')<br>17 Oktober 2024</h3>
               <div class="arrow">
                  <i class="fas fa-arrow-right card-icon" id="final"></i>
               </div>
            </a>
