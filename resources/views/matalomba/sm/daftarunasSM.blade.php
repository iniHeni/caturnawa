   ...
   <body>
    <div id="loadingDiv">
      ...
      <div class="konten">
        ...
        <form action="/unassm/checkout" method="POST" enctype="multipart/form-data" >
            @csrf
            <div class="form first">
                <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label for="buktifollow_1">@lang('messages.bukti')(Instagram,Tiktok,Youtube), max 3mb</label>
                            ...
                            <div class="input-field">
                                <label for="twibbon_1">Upload Twibbon, max 3mb </label>
                    ...
                    <div class="details ">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                <label for="buktifollow_2">@lang('messages.bukti')(Instagram,Tiktok,Youtube), max 3mb</label>
                            ...
                            <div class="input-field">
                                <label for="twibbon_2">Upload Twibbon, max 3mb </label>
                    ...
                    <div class="details personal">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                ...
                                <select name="fakultas_3" id="fakultas_3" @error('fakultas_3') is-invalid @enderror required>
                                    <option selected>@lang('messages.pilih')</option>
                                    <option id="FISIP">Fakultas Ilmu Sosisal dan Ilmu Politik</option>
                                    <option id="FH">Fakultas Hukum</option>
                                    <option id="FBS">Fakultas Bahasa dan Sastra</option>
                            ...
                            <div id="prodi_3" class="input-field">
                                @error('prodi_3')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="input-field">
                                <label for="buktifollow_3">@lang('messages.bukti')(Instagram,Tiktok,Youtube), max 3mb</label>
                            ...
                            <div class="input-field">
                                <label for="twibbon_3">Upload Twibbon, max 3mb </label>
                    ...
                    <div class="details ">
                        ...
                        <div class="fields">
                            ...
                            <div class="input-field">
                                ...
                                <select name="fakultas_4" id="fakultas_4" @error('fakultas_4') is-invalid @enderror required>
                                    <option selected>@lang('messages.pilih')</option>
                                    <option id="FISIP">Fakultas Ilmu Sosisal dan Ilmu Politik</option>
                                    <option id="FH">Fakultas Hukum</option>
                                    <option id="FBS">Fakultas Bahasa dan Sastra</option>
                            ...
                            <div id="prodi_4" class="input-field">
                                @error('prodi_4')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="input-field">
                                <label for="buktifollow_4">@lang('messages.bukti')(Instagram,Tiktok,Youtube), max 3mb </label>
                            ...
                            <div class="input-field">
                                <label for="twibbon_4">Upload Twibbon, max 3mb</label>
                    ...
                    <div class="details personal">
                        ...
                        <div class="fields"> 
                            ...
                            <div class="input-field">
                                ...
                                <select name="fakultas_5" id="fakultas_5" @error('fakultas_5') is-invalid @enderror required>
                                    <option selected>@lang('messages.pilih')</option>
                                    <option id="FISIP">Fakultas Ilmu Sosisal dan Ilmu Politik</option>
                                    <option id="FH">Fakultas Hukum</option>
                                    <option id="FBS">Fakultas Bahasa dan Sastra</option>
                            ...
                            <div id="prodi_5" class="input-field">
                                @error('prodi_5')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="input-field">
                                <label for="buktifollow_5">@lang('messages.bukti')(Instagram,Tiktok,Youtube), max 3mb</label>
                            ...
                            <div class="input-field">
                                <label for="twibbon_5">Upload Twibbon, max 3mb</label>
...
<button class="floating-button" onclick="window.history.back();">
  ...
  $(window).on("load", () => {
    ...
    <script type="text/javascript">
      ...
      <script src="../../js/formsm.js"></script>
