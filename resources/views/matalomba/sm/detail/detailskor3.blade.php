    ...
    <div id="loadingDiv">
      ...
      <header class="header" id="header">
        ...
        <div style="left: 200px" class="nav__item">
              ...
              <li class="nav__item">
                  <a href="{{url('matalomba/sm/final') }}" class="nav__link">Leaderboard</a>
               </li>
               <li class="nav__item">
            ...
            <div class="table-responsive" style="max-height: 1000px; overflow-x: auto; overflow-y: auto; position: relative;">
                <table class="table table-bordered " style="min-width: 1000px; margin-bottom: 0; border-collapse: collapse; ">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td>@lang('messages.kritsf1')</td>
                        <td style="text-align: center">{{ $dataa->skorkrit1 }}</td>
                    </tr>
                    <tr>

                        
                        <td>@lang('messages.kritsf2')</td>
              ...
              <tr>
                ...
                <td>@lang('messages.kritsf10')</td>
                <td style="text-align: center">{{ $dataa->skorkrit10}}</td>
              
            </tr>
            <tr>

              <td>@lang('messages.kritsf11')</td>
              <td style="text-align: center">{{ $dataa->skorkrit11}}</td>
            
          </tr>
          <tr>

            <td>@lang('messages.kritsf12')</td>
            <td style="text-align: center">{{ $dataa->skorkrit12}}</td>
