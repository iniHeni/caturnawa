                ...
                <table class="table table-bordered " style="min-width: 1000px; margin-bottom: 0; border-collapse: collapse; ">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td class="rata" style="text-align: left;" >{{ $dataa->krit1 }}</td>
                    </tr>
                    <tr>
                        ...
                        <td class="rata" style="text-align: left;" >{{ $dataa->krit2 }}</td>
                    ...
                    <tr>
                        ...
                        <td class="rata" style="text-align: left;" >{{ $dataa->krit3 }}</td>
                    ...
                    <tr>
                        ...
                        <td class="rata" style="text-align: left;" >{{ $dataa->krit4 }}</td>
                    ...
                    <tr>
                        ...
                        <td class="rata" style="text-align: left;" >{{ $dataa->krit5 }}</td>
                      
                    </tr>
        <tr><td colspan="1" style="text-align: center">Total Score</td>
          <td colspan="2" style="text-align: center">{{ $dataa->total }}</td></tr>
          </tr>
                </tbody>
                @endforeach
                </table>
