        ...
        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
                <div style="margin-right: 17rem" class="nav__item">
						<li><a href="{{url('matalomba/shortmovie') }}" height="20"><img src="../../img/ind.png"  /></a></li>
						<li><a href="{{url('#') }}" height="20"><img src="../../img/eng.png" /></a></li>
					</div>
                  <li class="nav__item">
                ...
                <div class="card-wrapper swiper-wrapper">
                    <div class="card swiper-slide">
                        <div class="image-content">
                            ...
                            <img src="../../img/sm1.png" alt="" class="card-img">
                            </div>
                        </div>
                        <div class="card-content">
                            <h2 class="name">Team 1</h2>
                            <p class="description">Information Participant</p>
                            <button class="button"><a href="{{url('matalomba/detailpesertaSM_eng') }}">View More</a></button>
                        </div>
                    </div>
                    <div class="card swiper-slide">
                        <div class="image-content">
