   ...
   <body>
      ...
      <div class="nav__menu" id="nav-menu">
        ...
        <div style="margin-right: 16rem" class="nav__item">
						<li><a href="{{url('matalomba/daftarSM') }}" height="20"><img src="../../img/ind.png"  /></a></li>
						<li><a href="#') }}.php" height="20"><img src="../../img/eng.png" /></a></li>
					</div>
                  <li class="nav__item">
                  ...
                  <li class="nav__item">
                     <a href="{{url('matalomba/shortmovie_eng') }}" class="nav__link">Participant</a>
                  </li>

                  <li class="nav__item">
                     <a href="{{url('matalomba/scoreSM') }}" class="nav__link">Score</a>
                  </li>

                  <li class="nav__item">
                     <a href="{{url('matalomba/shortmovie_eng') }}" class="nav__link">Round</a>
                  </li>

                  <li class="nav__item">
                     <a href="{{url('matalomba/shortmovie_eng') }}" class="nav__link"> Jury</a>
                  </li>
               </ul>
            ...
            <div class="form first">
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            <label>Study Card ID</label>
                            <input type="file" accept="image/*" require>
                        </div>
                        <div class="input-field">
                            <label>Formal Potograph With Red Background</label>
                            <input type="file" accept="image/*" require>
                        </div>
                        <div class="input-field">
                ...
                <span class="title">Upload File Team</span>
                    <div class="fields">
                    <div class="input-field">
                            <label>Delegation Letter from Institution</label>
